...
@section('content')
    <div class="flex flex-col items-center w-full">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-5 grid-rows-5 lg:grid-rows-2 w-full mt-6 lg:mt-14 mb-3 lg:mb-8 text-custom-white gap-3">
            ...
            <div class="col-span-2 w-full h-32 lg:h-40 bg-cover bg-center rounded-xl lg:cursor-pointer" style="background-image: url('{{ asset('img/delete-account.webp') }}')" onclick="deleteConfirmation()">
                <div class="flex flex-col gap-0.5 justify-end p-[10px] bg-gradient-to-t from-custom-dark/80 from-15% to-custom-dark/30 to-70% font-league w-full h-full rounded-xl lg:hover:bg-custom-dark-low lg:hover:transition-colors lg:duration-500">
                    <h2 class="text-lg/tight lg:text-2xl/[1.7rem] font-semibold">Nonaktifkan / Tutup Kursus</h2>
    ...
    <div id="delete-overlay" class="fixed hidden z-40 items-center justify-center top-0 left-0 w-full h-full bg-custom-dark/70">
        ...
        <div id="deleteConfirm" class="relative w-80 lg:w-[28rem] bottom-0 py-4 z-40 bg-custom-white rounded-xl">
            <div class="flex flex-row sticky px-5 bg-custom-white justify-between items-center pt-1 pb-4">
                <h2 class="font-encode text-xl/tight pt-1 lg:text-3xl font-semibold text-custom-dark ">Tutup Kursus?</h2>
    ...
    <div id="deactivateOverlay" class="fixed hidden z-40 items-center justify-center top-0 left-0 w-full h-full bg-custom-dark/70">
        ...
        <div id="deactivateConfirm" class="relative w-80 lg:w-[28rem] bottom-0 py-4 z-50 bg-custom-white rounded-xl">
            <div class="flex flex-row sticky px-5 bg-custom-white justify-between items-center pt-1 pb-4">
                <h2 class="font-encode text-xl/tight pt-1 lg:text-3xl font-semibold text-custom-dark ">Nonaktifkan Sementara?</h2>
