                    ...
                    <div class="swiper-slide overflow-y-auto">
                        <form action="{{ url('/edit-user-account-info') }}" method="post" enctype="multipart/form-data" class="px-6 pb-24 lg:pb-0" id="account-info-form">
                            ...
                            <div class="flex flex-col gap-1 mb-4">
                                <h2 class="text-xl lg:text-2xl/snug text-custom-dark font-encode tracking-tight font-semibold">Data Personal Anda</h2>
                            </div>
                            <div class="flex flex-col mt-4 gap-5 lg:gap-7">
                                ...
                                {{-- Input Full Name --}}
                                <div class="flex flex-col gap-2">
                                    <label for="fullname" class="font-semibold font-league text-lg lg:text-xl text-custom-grey">Nama Anda<span class="text-custom-destructive">*</span></label>
                                ...
                                {{-- Input Age --}}
                                <div class="flex flex-col gap-2">
                                    <label for="age" class="font-semibold font-league text-lg lg:text-xl text-custom-grey">Usia</label>
