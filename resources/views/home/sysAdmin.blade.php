...
@section('content')
    ...
    <div class="relative flex flex-col w-full h-dvh">
        ...
        <div class="fixed bottom-5 left-1/2 bg-custom-dark transform -translate-x-1/2 flex flex-row gap-2 p-2 rounded-full">
            {{-- Account --}}
            <a href="{{ url('/sysAdmin-index') }}" class="px-5 py-2.5 font-league font-normal text-custom-white text-lg/snug bg-custom-green/25 rounded-full cursor-pointer duration-300">Pengguna</a>
            {{-- Certificate --}}
