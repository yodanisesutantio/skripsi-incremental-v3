...
@section('content')
    ...
    <div class="lg:grid lg:grid-cols-3 lg:pl-16 lg:pr-48">
        ...
        <div class="lg:col-span-2 lg:px-24">
            <form action="/instructor-certificate/create" method="POST" class="px-6 pb-24 lg:pb-0 lg:pt-5" id="uploadNewCertificateForm" enctype="multipart/form-data">
                @csrf
                {{-- Form Sub Headers --}}
                ...
                <div class="lg:flex flex-row w-full lg:mt-5 py-4 lg:py-5 items-center justify-between bg-custom-white hidden">
                    <a href="/instructor-certificate" class="text-custom-dark font-league font-medium px-1 pt-2 pb-1 text-lg/none underline hover:text-custom-green-hover">Batal</a>
