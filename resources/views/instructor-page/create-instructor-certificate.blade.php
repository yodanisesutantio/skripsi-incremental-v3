...
@section('content')
    ...
    <div class="sticky z-40 top-0 pt-8 pb-4 bg-custom-white flex flex-col gap-5 lg:hidden" id="form-header">
        <div class="flex flex-col gap-1 px-6">
            ...
            <p class="text-custom-grey text-lg/tight lg:text-2xl/tight font-league mt-2">Unggah Sertifikat Instruktur Anda</p>
        </div>
    </div>
    ...
    <div class="lg:grid lg:grid-cols-3 lg:pl-16 lg:pr-48">
        ...
        <div class="lg:col-span-2 lg:px-24">
            <form action="{{ url('/instructor-certificate/create') }}" method="POST" class="px-6 pb-24 lg:pb-0 lg:pt-5" id="uploadNewCertificateForm" enctype="multipart/form-data">
                @csrf
                {{-- Form Sub Headers --}}
                <div class="mb-4 lg:mt-4 hidden lg:block">
                    <h2 class="text-xl lg:text-2xl/snug text-custom-dark font-encode tracking-tight font-semibold">Unggah Sertifikat Baru</h2>
                </div>
                    ...
                    <label for="certificatePath" class="cursor-pointer rounded-lg">
                        ...
                        <div class="relative flex flex-col items-center justify-center w-full rounded-lg h-60 bg-cover bg-center bg-custom-disabled-light/60 hover:bg-custom-disabled-light border-2 border-custom-grey border-dashed overflow-hidden duration-300" id="certificatePath_wrapper">
                            ...
                            <div class="flex flex-col items-center justify-center px-8 pt-5 pb-6" id="uploadInfo">
                                ...
                                <p class="mt-4 mb-2 text-sm lg:text-base text-center text-custom-grey"><span class="font-semibold">Tekan untuk memilih sertifikat yang akan diupload</span> atau seret sertifikat anda ke area ini</p>
                ...
                <div class="flex flex-col gap-1 mt-8">
                    ...
                    {{-- Input Date Column --}}
                    <input type="date" name="startCertificateDate" id="startCertificateDate" class="p-4 font-league font-medium text-lg bg-custom-white-hover text-custom-secondary placeholder:#48484833 rounded-lg @error('startCertificateDate') border-2 border-custom-destructive @enderror">
                ...
                <div class="flex flex-col gap-1 mt-8">
                    ...
                    {{-- Input Date Column --}}
                    <input type="date" name="endCertificateDate" id="endCertificateDate" class="p-4 font-league font-medium text-lg bg-custom-white-hover text-custom-secondary placeholder:#48484833 rounded-lg @error('endCertificateDate') border-2 border-custom-destructive @enderror">
                    {{-- Error in Validation Message --}}
                ...
                <div class="lg:flex flex-row w-full lg:mt-5 py-4 lg:py-5 items-center justify-between bg-custom-white hidden">
                    <a href="{{ url('/instructor-certificate') }}" class="text-custom-dark font-league font-medium px-1 pt-2 pb-1 text-lg/none underline hover:text-custom-green-hover">Batal</a>
                    <button type="submit" class="px-8 py-3 rounded-lg lg:rounded-lg bg-custom-green hover:bg-custom-green-hover text-center lg:text-lg text-custom-white-hover font-semibold lg:order-2 duration-500">Ajukan Sertifikat Baru</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="flex flex-row fixed w-full z-20 bottom-0 px-6 py-4 lg:py-5 items-center justify-between bg-custom-white lg:hidden" id="mobileButtonGroupWrapper">
        <a href="{{ url('/instructor-certificate') }}" class="text-custom-dark font-league font-medium px-1 pt-2 pb-1 text-lg/none underline hover:text-custom-green-hover">Batal</a>
        <button type="submit" id="mobileSubmitButton" class="px-6 py-3 rounded-lg lg:rounded-lg bg-custom-green hover:bg-custom-green-hover text-center lg:text-lg text-custom-white-hover font-semibold lg:order-2 duration-500">Ajukan Sertifikat Baru</button>
    </div>
    ...
    <script>
        ...
        $('#mobileSubmitButton').click(function(event) {
            ...
            $('#uploadNewCertificateForm').submit();
        });
        ...
        dropArea.on({
            ...
            drop: function(e) {
                ...
                if (file) {
                    ...
                    $('#certificatePath').prop('files', e.originalEvent.dataTransfer.files);
