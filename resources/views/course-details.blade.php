...
@section('content')
    <div class="flex flex-col lg:flex-row">
        {{-- Back Button --}}
        <a href="{{ url('/user-index') }}" class="flex absolute top-8 left-5 bg-custom-dark-low rounded-full z-20 p-3 lg:hidden">
        ...
        <div class="lg:flex lg:flex-col lg:w-3/5 lg:h-screen lg:overflow-y-auto">
            ...
            <div class="flex flex-col px-6 mt-5 lg:px-8 lg:mt-8 gap-1">
                ...
                <p class="text-custom-grey text-lg lg:text-xl font-league">oleh <span class="font-semibold text-custom-dark"><a href="{{ url('/driving-school-profile') }}">{{ $classProperties->admin->fullname }}</a></span></p>
