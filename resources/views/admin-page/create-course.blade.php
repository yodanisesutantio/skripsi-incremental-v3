...
@section('content')
    ...
    <form action="/admin-profile/edit" method="post" enctype="multipart/form-data">
        ...
        <div class="flex flex-col gap-2">
            <label for="course_thumbnail" class="flex flex-col items-center justify-center w-full h-60 border-2 border-custom-grey border-dashed rounded-lg cursor-pointer bg-custom-disabled-light/60 hover:bg-custom-disabled-light duration-200">
                <div class="flex flex-col items-center justify-center px-8 pt-5 pb-6">
                    ...
                    <p class="text-sm text-custom-grey">Format yang didukung .jpg, .png, atau .webp (MAX. 2 MB)</p>
                </div>
