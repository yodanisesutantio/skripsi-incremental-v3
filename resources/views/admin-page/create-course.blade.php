        ...
        <div class="lg:col-span-2 lg:px-24">
            <form action="/admin-profile/edit" method="post" enctype="multipart/form-data" class="px-6 pb-24 lg:pt-5 lg:pb-0">
                ...
                <div class="flex flex-col gap-2">
                    <label for="course_thumbnail" class="cursor-pointer rounded-lg bg-custom-disabled-light/60 hover:bg-custom-disabled-light duration-200">
                        <div class="flex flex-col items-center justify-center w-full rounded-lg h-60 bg-cover bg-center border-2 border-custom-grey border-dashed overflow-hidden" id="course_thumbnail_wrapper">
                            ...
                            <img id="course_thumbnail_preview" class="hidden w-full h-full object-cover">
    ...
    <script>
        ...
        $('#course_thumbnail').on('change', function(event) {
            ...
            if (file) {
                ...
                $('#course_thumbnail_wrapper').addClass('border-2 border-custom-grey border-dashed');
                $('#uploadInfo').removeClass('hidden'); // Hide the uploadInfo
            }
        });
    </script>
@endsection