...
@section('content')
    ...
    <h2 class="text-xl lg:text-2xl/snug mt-10 mb-3 lg:mt-10 lg:mb-3 text-custom-dark font-encode font-semibold">Daftar Izin Kursus Anda</h2>
    @if ($licenses)
                    ...
                    <div class="flex flex-row flex-grow p-3 lg:p-5 bg-custom-white-hover w-full font-league text-custom-dark">
                        <div class="grid grid-cols-3 w-full">
                            <div class="flex flex-col">
                                ...
                                <h3 class="text-custom-dark font-encode font-semibold text-lg lg:text-xl">{{ $listOfLicense['licenseStatus'] }}</h3>
                            </div>
                            <div class="col-span-2 flex flex-col">
                                <p class="text-custom-grey font-league text-right font-medium text-base lg:text-lg mt-1">Tanggal Akhir Berlaku :</p>
                                <h3 class="text-custom-dark font-encode text-right font-semibold text-lg lg:text-xl">{{ $listOfLicense['formattedEndDate'] }}</h3>
                            </div>
                        </div>
                    </div>
                </a>
