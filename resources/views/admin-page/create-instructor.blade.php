...
@section('content')
    ...
    <div class="lg:grid lg:grid-cols-3 lg:pl-16 lg:pr-48">
        ...
        <div class="lg:col-span-2 lg:px-24">
            <form action="{{ url('/admin-manage-instructor/create') }}" method="post" enctype="multipart/form-data" class="px-6 pb-24 lg:pt-5 lg:pb-0" id="create-instructor-form">
                @csrf
                {{-- Form Sub Headers --}}
                ...
                <div class="flex flex-col mt-4 gap-5 lg:gap-7">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <label for="hash_for_profile_picture" class="relative w-fit">
                            ...
                            {{-- Temporary Blank Profile Picture --}}
                ...
                <div class="lg:flex flex-row w-full lg:mt-5 py-4 lg:py-5 items-center justify-between bg-custom-white hidden">
                    <a href="{{ url('/admin-manage-instructor') }}" class="text-custom-dark font-league font-medium px-1 pt-2 pb-1 text-lg/none underline hover:text-custom-green-hover cancelLink">Batal</a>
    ...
    <div class="flex flex-row fixed w-full z-20 bottom-0 px-6 py-4 lg:py-5 items-center justify-between bg-custom-white lg:hidden">
        <a href="{{ url('/admin-manage-instructor') }}" class="text-custom-dark font-league font-medium px-1 pt-2 pb-1 text-lg/none underline hover:text-custom-green-hover">Batal</a>
    ...
    <script>
        ...
        $('#hash_for_profile_picture').on('change', function(event) {
            const file = event.target.files[0]; // Read the uploaded profile picture
            if (file) {
        ...
        $('#certificatePath').on('change', function(event) {
            const file = event.target.files[0]; // Read the Uploaded Certificate 
            const reader = new FileReader();
            reader.onload = function(e) {
        ...
        // Change states, when there's an uploaded certificates
