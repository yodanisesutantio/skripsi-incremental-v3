...
@section('content')
    ...
    @else
        ...
        <div class="flex lg:grid flex-col lg:grid-cols-2 gap-6 mt-5 lg:mt-10 mb-7 lg:mb-14">
            ...
            <div class="w-full bg-custom-white-hover p-3 rounded-xl overflow-hidden drop-shadow-lg lg:cursor-pointer lg:drop-shadow lg:hover:drop-shadow-lg duration-300">
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex flex-col gap-1">
                            ...
                            <p class="font-league text-[17px]/tight text-custom-grey">Pertemuan ke-{{ $activeStudent->meeting_number }}</p>
                        </div>
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex flex-row items-center w-fit gap-2 px-2 py-1 border border-custom-green/50 rounded-lg">
                                ...
                                <h4 class="font-league text-base/tight mt-1 text-custom-green font-medium line-clamp-1 whitespace-nowrap">{{ $activeStudent->next_course_date }}</h4>
                            </div>
                            {{-- Next Course Time --}}
                            <div class="flex flex-row items-center w-fit gap-2 px-2 py-1 border border-custom-green/50 rounded-lg">
                                ...
                                <h4 class="font-league text-base/tight mt-1 text-custom-green font-medium line-clamp-1 whitespace-nowrap">{{ $activeStudent->course_time }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
