...
class EnrollmentController extends Controller
{
    ...
    public function newStudent(Request $request, $course_name, $course_id) {
        ...
        $request->validate([
            ...
            'student_birth_of_date' => ['required', 'date', 'before:' . now()->subYears(18)->toDateString()],
        ...
        [
            ...
            'student_birth_of_date.before' => 'Anda masih dibawah umur. Pastikan anda sudah berusia 18 Tahun.',
